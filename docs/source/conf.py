...
# test_kedro_mlflow documentation build
...
from test_kedro_mlflow import __version__ as release

# -- Project information -----------------------------------------------------

project = "test_kedro_mlflow"
author = "Kedro"
...
htmlhelp_basename = "test_kedro_mlflowdoc"
...
latex_documents = [
    (
        master_doc,
        "test_kedro_mlflow.tex",
        "test_kedro_mlflow Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "test_kedro_mlflow",
        "Project test_kedro_mlflow codebase.",
        "Data-Science",
    )
]
